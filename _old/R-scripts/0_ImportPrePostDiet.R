...
#Import Excel
sampleDt = read.xlsx("../data/clinics/Copia di Microobesomics_clinical data IGA 260324.xlsx", check.names = F, row.names = 1, sheetName = "group1vs2")
...
saveRDS(ps_filt1vs2, file = paste0("../data/metagenomics/ps_filt1vs2.rds"))
saveRDS(mtbDt, file = paste0("../data/metabolomics/mtbDt1vs2.rds"))
saveRDS(sampleDt, file = paste0("../data/clinics/sampleDt1vs2.rds"))
